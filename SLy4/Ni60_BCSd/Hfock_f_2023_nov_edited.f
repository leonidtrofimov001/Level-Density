...
ccccccc26.11.94      rr2(i,j2,j1)=rp(j2,j1)
  ...
  207 if(kj.eq.na)goto 20
   ...
   89 continue
      ...
      GP=0.283333     !GNP, 0.840 \ GP = 17/A (MeV)
      GN=0.383333      !0.686 \ GN = 23/A (MeV)
...
c      data ln/22/,l/10,12,0/,
c     *alo/2,4,2,6,2,4,8,0,0,0,
c     *2,4,2,6,2,4,8,2,0,0,0,0,18*0./
c      data al/0.,1.,1.,2.,0.,2.,3.,1.,3.,1.,
c     *0.,1.,1.,2.,0.,2.,3.,1.,3.,1.,4.,2.,18*0./
c      data aj/.5,1.5,.5,2.5,.5,1.5,3.5,1.5,2.5,0.5,
c     *.5,1.5,.5,2.5,.5,1.5,3.5,1.5,2.5,0.5,4.5,2.5,18*0./
c      data en/-45,-32.2,-30.6,-18.,-13.,-14.,-7.0,-1.,-1.,-0.5,
c     *-54.,-41.,-40.1,-27.3,-23.,-23.,-16.0,-12.0,-8.,-9.,-4.,-2.,
c     *18*0./
c      data h1,h2,n,ht,rt/.015,.125,794,.02,.39/
c      data bf/2.6,2.4,2.4,2.1,2.1,1.9,1.8,1.7,1.7,1.6,
c     *2.6,2.4,2.3,2.1,2.0,1.9,1.8,1.7,1.6,1.5,1.4,1.3,
c     *18*0./
...
cccccccccccccc Ni60 (+3 neutron states) cccccccccccccccccccc
      data ln/21/,l/10,11,0/,
     *alo/2,4,2,6,2,4,8,0,0,0,2,4,2,6,2,4,8,4,0,0,0,0,18*0./
      data al/0.,1.,1.,2.,0.,2.,3.,1.,3.,1.,
     *0.,1.,1.,2.,0.,2.,3.,1.,3.,1.,4.,0.,18*0./
      data aj/.5,1.5,.5,2.5,.5,1.5,3.5,1.5,2.5,0.5,
     *.5,1.5,.5,2.5,.5,1.5,3.5,1.5,2.5,0.5,4.5,0.,18*0./
      data en/-45,-32.2,-30.6,-18.,-13.,-14.,-7.0,-1.,-1.,-1.,
     *-54.,-41.,-40.1,-27.3,-23.,-23.,-16.0,-12.0,-8.,-9.,-4.,19*0./
      data h1,h2,n,ht,rt/.015,.125,794,.02,.39/
      data bf/2.6,2.4,2.4,2.1,2.1,1.9,1.8,1.8,1.8,1.8,
     *2.6,2.4,2.3,2.1,2.,1.9,1.8,1.7,1.6,1.5,1.4,19*0./
